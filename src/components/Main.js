 ...
 */
  ...
  handledbClick:function(e){
  	document.getElementById("embed").pause();
  },
...
// 如果是居中的图片， z-index设为11
    ...
    return(
      <figure className={imgFigureClassName} style={styleObj} onClick={this.handleClick} onDoubleClick={this.handledbClick}>
